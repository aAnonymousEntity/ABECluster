...
public class deposit_token {
    ...
    static {
        loadAddressData("exchanges_bnb.csv", exchangeAddresses);
        loadAddressData("miners_bnb.txt", minerAddresses);
    }
    ...
    public static void main(String[] args) {
        ...
        String outputDir = "Randomadd_deposit_token/";
                    ...
                    for (Edge outEdge : outEdges) {
                        ...
                        if ((blockIn - blockOut) < 3200 && valueDiff.compareTo(ETH_THRESHOLD) <= 0) {
                            ...
                            if (inNodeAddr == null || 
                                ...
                                // exchangeAddresses.contains(inNodeAddr.toLowerCase()))
                                {
                                // System.out.println("It is an exchange!");
                                continue;
                            }
                            ...
                            if (outNodeAddr == null || !exchangeAddresses.contains(outNodeAddr.toLowerCase())) {
                                // System.out.println("Not an exchange!");
                                // System.out.println(outNodeAddr);
                                continue;
